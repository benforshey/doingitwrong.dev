...
<h1>Tips Consolidated from The Pragmatic Programmer</h1>

<p>Tips with a short takeaway.</p>
...
<section>
	...
	<dl>
		...
		<dd>
			The more effective your communication, the more influential you can
			become.
		</dd>
		...
		<dt>p. 28: &numero;14 Good Design Is Easier to Change Than Bad Design</dt>
		<dd>
			<abbr>ETC</abbr> (Easier to Change) is a value&mdash;not a rule&mdash;that
			is the beating heart of many complex design principles. If you&rsquo;re not
			sure what is the appropriate change toward ETC, try to make what your code
			replaceable and describe the situation in your engineering daybook (tag it).
			When it&rsquo;s time to change the code, review your notes and train your initial
			instinct.
		</dd>

		<dt>p. 31: &numero;15 Don&rsquo;t Repeat Yourself&</dt>
		<dd>
			Applies to code, documentation, data, <dfn
				><abbr title="Application Programming Interface">API</abbr></dfn
			>s, even developer knowledge.
		</dd>

		<dt>p. 38: &numero;16 Make It Easy to Reuse</dt>
		<dd>
